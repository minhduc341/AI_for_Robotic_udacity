...
def run(param1, param2, param3):
    ...
    for i in range(N):
        diff_crosstrack_error = myrobot.y - crosstrack_error #time = 1
        int_crosstrack_error = int_crosstrack_error + myrobot.y
        steering = - param1 * myrobot.y - param2 * diff_crosstrack_error - param3 * int_crosstrack_error
        crosstrack_error = myrobot.y
